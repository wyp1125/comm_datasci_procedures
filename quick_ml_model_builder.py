...
parser.add_argument('-i', '--inprefix', type=str, required=True, help="prefix of feature files (.codedx & .codedy)")
...
x_trn, x_tst, y_trn, y_tst = train_test_split(fea, rsp, test_size=0.2)
